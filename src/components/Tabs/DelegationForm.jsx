  ...
  return (
    <div className='form'>
      <div className='input__wrapper'>
        <div className={classNames('balance', { 'balance--disabled': !accountAddress || !validator })}>Balance - <span>{formatWei(balanceToShow)} BESC</span></div>
        <div className='input'>
          <Field name='amount'>
            {({
              field
          ...
          <span className='symbol'>BESC</span>
        </div>
      </div>
